...
serve(async (req) => {
  ...
  try {
    const { image, textQuery } = await req.json();
    ...
    const geminiResponse = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent?key=${geminiApiKey}`, {
      ...
      body: JSON.stringify({
        contents: [{
          parts: [
            { text: "Du er en dansk affaldssorteringsekspert. ANALYSÉR ALLE SYNLIGE OBJEKTER I BILLEDET GRUNDIGT og identificer potentielle affaldsgenstande.\n\n**ANALYSÉR ULTRA GRUNDIGT - MEGET HØJE KRAV:**\n- SCAN billedet systematisk fra venstre til højre, top til bund\n- SE PÅ ALLE objekter i billedet - både store, mellemu og SÅ SMÅ objekter som muligt\n- Identificer MINDST 8-12 objekter hvis de er synlige\n- Vær EKSTREMT opmærksom på små detaljer, perler, småting, elektroniske genstande\n- UNDGÅ at være selektiv - det er MEGET bedre at identificere for mange end for få\n- Analysér objekternes materiale, form, funktion og potentielle affaldskategori\n- SE efter mærkater, symboler, pantsymboler og andre karakteristika\n- Inkludér ALT der kunne være affald, inkl. emballage, småting, elektronik\n- **FOKUS PÅ SÅ MANGE OBJEKTER SOM MULIGT**\n\n**VIGTIGE KATEGORIER (vær super specifik):**\n- \"pant\": flasker/dåser med pantsymbol eller pantbar emballage (★ MEGET VIGTIG)\n- \"plastik\": ALT plastik - flasker, poser, emballage, legetøj, perler, små plastikbidder, tape/klæbebånd\n- \"organisk\": madaffald, frugt, grøntsager, kompost, skrald\n- \"elektronik\": telefoner, computere, bilnøgler, fjernstyringer, earbuds, batterier, kids sleep clock, små elektroniske enheder\n- \"farligt\": batterier, maling, kemikalier, giftige stoffer\n- \"pap\": æsker, karton, papir\n- \"glas\": glasflasker, glasskår, glasgenstande\n- \"metal\": metaldåser, aluminium, metalgenstande, nåle, pins\n- \"tekstil\": tøj, sko, stof\n- \"træ\": træobjekter, træaffald\n\n**VÆR SÆRLIGT OPMÆRKSOM PÅ DISSE SMÅ OBJEKTER:**\n- Små elektroniske enheder som \"Kid Sleep Clock\", vækkeure, timere\n- Små objekter som perler, knapper, pins, nåle, små plastikbidder\n- Legetøj og småting (ofte plastik eller metal)\n- Elektroniske komponenter, batterier, chips\n- Tape, klæbebånd (altid plastik/blød plast)\n- Bolsjepapir, slik-emballage\n- Alt der ligner affald eller kunne blive til affald\n\n**KRAV: ANALYSÉR MINDST 8-12 OBJEKTER** - vær ekstrem grundig!\n\nReturner JSON: {\"komponenter\":[{\"description\":\"specifikt_navn\",\"materiale\":\"kategori\",\"score\":0.8}]}. Kun JSON svar." },
            { 
              inline_data: {
