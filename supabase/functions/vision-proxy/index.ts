  ...
  try {
    ...
    const geminiResponse = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent?key=${geminiApiKey}`, {
      ...
      body: JSON.stringify({
        contents: [{
          parts: [
            { text: "Du er en ekspert i affaldssortering. Din opgave er at identificere de specifikke genstande i billedet så præcist som muligt.\n\n**VIGTIGE RETNINGSLINJER:**\n\n1. **PRÆCIS IDENTIFIKATION:** Identificer det eksakte objekt du ser - fx \"træbjælke\", \"plastikflaske\", \"æg\", \"appelsin\", \"mobiltelefon\", \"tøjbøjle\" osv.\n\n2. **MATERIALE KATEGORIER:**\n   - \"plastik\": plastikgenstande, poser, flasker\n   - \"organisk\": madaffald, frugt, grøntsager\n   - \"elektronik\": telefoner, computere, batterier\n   - \"farligt\": batterier, maling, kemikalier\n   - \"pap\": æsker, karton\n   - \"glas\": glasflasker, krukker\n   - \"metal\": metaldåser, aluminium\n   - \"tekstil\": tøj, sko\n   - \"træ\": træbjælker, træmøbler\n\n3. **UNDGÅ FEJL:** Brug ikke generelle termer - vær specifik om hvad du ser.\n\nAnalyser billedet og identificer alle synlige genstande med høj præcision.\n\nReturner JSON format: {\"komponenter\":[{\"description\":\"specifikt_navn\",\"materiale\":\"kategori\",\"score\":0.9}]}. Kun JSON svar." },
            { 
              inline_data: {
